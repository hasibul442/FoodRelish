        ...
        <div class="col-md-6">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="insert-form" id="insert-form" method="post" action="{{route('employee.store')}}" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-primary btn-block" name="submit" id="submit">Create Employee</button>
                    </div>
                    </form>
                </div>
            </div>
